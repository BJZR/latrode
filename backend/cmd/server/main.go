...
func main() {
	...
	adminMux.HandleFunc("DELETE /users/{id}", adminHandler.DeleteUser)
	adminMux.HandleFunc("DELETE /users", adminHandler.DeleteUsers)
	...
	adminMux.HandleFunc("DELETE /orders/{id}", adminHandler.DeleteOrder)
	adminMux.HandleFunc("DELETE /orders", adminHandler.DeleteOrders)
	adminMux.HandleFunc("DELETE /orders-all", adminHandler.DeleteAllOrders)
